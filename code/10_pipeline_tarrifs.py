...
colonial_pipeline_tarifs = {
    ...
    'destination': [
        'linden', 'linden-buckeye', 'linden', 'linden-buckeye', 'linden', 'linden-buckeye',
        'linden', 'linden-buckeye', 'linden', 'linden-buckeye', 'linden', 'linden-buckeye',
        'linden', 'linden-buckeye', 'linden', 'linden-buckeye', 'linden', 'linden-buckeye',
        'linden', 'linden-buckeye',
        ],
    'date': [
        '06-30-2024', '06-30-2024', '07-01-2023', '07-01-2023', '07-10-2019', '07-10-2019',
        '07-01-2018', '07-01-2018', '07-23-2017', '07-23-2017', '07-01-2016', '07-01-2016',
        '07-01-2015', '07-01-2015', '07-01-2014', '07-01-2014', '07-01-2013', '07-01-2013',
        '07-01-2012', '07-01-2012',
        ],
    'tariff rate': [
        303.99, 303.99, 303.99, 303.99, 246.27, 246.27,
        230.59, 230.59, 220.85, 220.85, 212.56, 212.56,
        208.82, 208.82, 197.93, 197.93, 189.41, 189.41,
        189.41, 189.41,
        ],
}
...
colonial_pipeline_tarifs_pivoted_df.to_csv(f'{data}/colonial_pipeline_tariffs_wide.csv', 
                                           index=False)